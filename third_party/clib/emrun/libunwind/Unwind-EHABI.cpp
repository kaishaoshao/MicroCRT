...
#ifdef __BIG_ENDIAN
      value = *((uint8_t*)valuep) << 24 | (*((uint8_t*)valuep+1)) << 16 | (*((uint8_t*)valuep+2)) << 8 | (*((uint8_t*)valuep+3));
#else
      value = *((uint8_t*)valuep) | (*((uint8_t*)valuep+1)) << 8 | (*((uint8_t*)valuep+2)) << 16 | (*((uint8_t*)valuep+3)) << 24;
#endif
      break;

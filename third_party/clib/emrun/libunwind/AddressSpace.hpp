...
#define __eh_frame_start __eh_frame_start__
#define __eh_frame_end __eh_frame_end__
#endif
...
#define __eh_frame_hdr_start __eh_frame_hdr_start__
#define __eh_frame_hdr_end __eh_frame_hdr_end__
#endif
...
public:
  ...
  uint16_t         get16(pint_t addr) {
    ...
    //memcpy(&val, (void *)addr, sizeof(val));
#ifdef __BIG_ENDIAN
    val = *((uint8_t*)addr) << 8 | (*((uint8_t*)addr+1));
#else
    val = *((uint8_t*)addr) | (*((uint8_t*)addr+1)) << 8;
#endif
    return val;
  }
  uint32_t         get32(pint_t addr) {
    ...
    //memcpy(&val, (void *)addr, sizeof(val));
#ifdef __BIG_ENDIAN
    val = *((uint8_t*)addr) << 24 | (*((uint8_t*)addr+1)) << 16 | (*((uint8_t*)addr+2)) << 8 | (*((uint8_t*)addr+3));
#else
    val = *((uint8_t*)addr) | (*((uint8_t*)addr+1)) << 8 | (*((uint8_t*)addr+2)) << 16 | (*((uint8_t*)addr+3)) << 24;
#endif
    return val;
  }

...
//
#define            __SEGGER_FPL_VERSION      20801
...
long               __fixsfdi                 (float f);
long               __fixdfdi                 (double __x);
unsigned long      __fixunsdfdi              (double __x);
#else
...
#if defined(__aarch64__)
unsigned long      __fixunssfdi              (float f);
#else

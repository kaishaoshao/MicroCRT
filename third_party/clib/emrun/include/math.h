...
#undef islessequal
#undef islessgreater
inline bool isinf(float __x) { return __SEGGER_RTL_float32_isinf(__x) != 0; }
inline bool isinf(double __x) { return __SEGGER_RTL_float64_isinf(__x) != 0; }
inline bool isinf(long double __x) { return __SEGGER_RTL_float64_isinf(__x) != 0; }
inline bool isnan(float __x) { return __SEGGER_RTL_float32_isnan(__x) != 0; }
inline bool isnan(double __x) { return __SEGGER_RTL_float64_isnan(__x) != 0; }
inline bool isnan(long double __x) { return __SEGGER_RTL_float64_isnan(__x) != 0; }
inline bool isfinite(float __x) { return __SEGGER_RTL_float32_isfinite(__x) != 0; }
inline bool isfinite(double __x) { return __SEGGER_RTL_float64_isfinite(__x) != 0; }
inline bool isfinite(long double __x) { return __SEGGER_RTL_float64_isfinite(__x) != 0; }
inline bool isnormal(float __x) { return __SEGGER_RTL_float32_isnormal(__x) != 0; }
inline bool isnormal(double __x) { return __SEGGER_RTL_float64_isnormal(__x) != 0; }
inline bool isnormal(long double __x) { return __SEGGER_RTL_float64_isnormal(__x) != 0; }
...
inline bool signbit(long double __x) { return __SEGGER_RTL_float64_signbit(__x) != 0; }
...
inline int fpclassify(long double __x) { return __SEGGER_RTL_float64_classify(__x); }
...
inline bool isunordered(long double __a, long double __b) { return fpclassify(__a) == FP_NAN || fpclassify(__b) == FP_NAN; }
...
inline bool isgreater(long double __x, long double __y) { return !isunordered(__x, __y) && (__x > __y); }
...
inline bool isgreaterequal(long double __x, long double __y) { return !isunordered(__x, __y) && (__x >= __y); }
...
inline bool isless(long double __x, long double __y) { return !isunordered(__x, __y) && (__x < __y); }
...
inline bool islessequal(long double __x, long double __y) { return !isunordered(__x, __y) && (__x <= __y); }
...
inline bool islessgreater(long double __x, long double __y) { return !isunordered(__x, __y) && (__x < __y || __x > __y); }
}

...
extern _LIBCXXABI_FUNC_VIS /*_LIBCXXABI_NORETURN*/ void // gcc doesn't like _LIBCXXABI_NORETURN
...
extern _LIBCXXABI_FUNC_VIS /*_LIBCXXABI_NORETURN*/ void __cxa_rethrow(); // gcc doesn't save registers with this

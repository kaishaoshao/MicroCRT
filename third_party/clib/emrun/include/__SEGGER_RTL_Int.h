...
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_day_names          [];
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_month_names        [];
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_am_pm_indicator    [];
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_time_format        [];
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_date_format        [];
extern __SEGGER_RTL_RODATA char            __SEGGER_RTL_c_locale_date_time_format   [];
...
void                          __SEGGER_RTL_init_prin_l                         (__SEGGER_RTL_prin_t *ctx, locale_t loc);
...
void                          __SEGGER_RTL_init_scan                           (__SEGGER_RTL_scan_t *ctx);
void                          __SEGGER_RTL_init_scan_l                         (__SEGGER_RTL_scan_t *ctx, locale_t loc);
...
void                        * __SEGGER_RTL_alloc                               (size_t size);
void                        * __SEGGER_RTL_aligned_alloc                       (size_t align, size_t size);
void                        * __SEGGER_RTL_realloc                             (void *p, size_t __size);
void                          __SEGGER_RTL_free                                (void *p);
void                          __SEGGER_RTL_constraint_violation                (const char *msg, void *ptr, int error);

struct __SEGGER_RTL_POSIX_locale_s * __SEGGER_RTL_current_locale               (void);

//
// For benchmarking division code
//
...
//
// When compiling the library, ensure Annex K objects of C11/18 are defined.
//

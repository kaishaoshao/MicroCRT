...
/*********************************************************************
*
*       __SEGGER_RTL_print_wide_string_wchar()
*
*/
...
*    Formatted write to wide string.
*
*  Parameters
*    s      - Pointer to array that receives the formatted output.
*    len    - Maximum number of wide characters to fill in s.
*    format - Pointer to zero-terminated format control string.
*
*  Return value
*    Returns number of wide characters written to s (not counting the
*    terminating wide null), or a negative value if an output or encoding
*    error occurred.
*
*  Additional information
*    Writes to the wide string pointed to by s under control of the
*    string pointed to by format that specifies how subsequent arguments
*    are converted for output. A null wide character is written at the
*    end of the wide characters written; it is not counted as part of
*    the returned value.
*    
...
*
*  Function description
*    Formatted write to wide string, variadic.
*
*  Parameters
*    s      - Pointer to array that receives the formatted output.
*    len    - Maximum number of wide characters to fill in s.
...
*    the returned value.
*
*    Before calling vsprintf(), arg must be initialized by the va_start
*    macro (and possibly subsequent va_arg calls).  vswprintf() does not
